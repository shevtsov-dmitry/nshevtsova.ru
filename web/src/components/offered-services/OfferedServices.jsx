...
export default function OfferedServices() {
    ...
    const ServiceDiv = ({ title, icon, description }) => {
        return (
            <div
                className={
                    `grid h-auto w-full grid-cols-4 grid-rows-3 gap-2 rounded-[0.75rem] border border-gray-300 py-[4%] pr-[5%] ` +
                    `${isMobile ? 'grid-cols-1 grid-rows-none py-[2%] pr-[2%]' : ''}`
                }
            >
                <div className="col-span-1 row-span-1 flex h-full w-full items-center justify-center">
                    <img
                        className={`${isMobile ? 'w-[40%]' : 'w-[60%]'}`}
                        src={`${icon}`}
                    />
                </div>
    ...
    return (
        <div className="h-fit w-full">
            <Slide triggerOnce>
                <div
                    className={`flex h-1/5 items-center justify-start ${isMobile ? 'ml-[2%]' : 'ml-[5%]'}`}
                >
                    <h1
                        className={`mb-[2%] font-ptsans-bold ${isMobile ? 'text-2xl' : 'text-4xl'}`}
                    >
            ...
            <div
                className={`grid h-4/5 w-full gap-5 px-[5%] ${isMobile ? 'grid-cols-1' : 'grid-cols-3'}`}
            >
                <Slide
                ...
                >
                    ...
                    <Fade delay={4 * FADE_REVEAL_BASE_TIMING} triggerOnce>
                        <ServiceDiv
                            title={'АРЕНДА'}
                    ...
                    <Fade delay={5 * FADE_REVEAL_BASE_TIMING} triggerOnce>
                        <ServiceDiv
                    ...
                    <Fade delay={6 * FADE_REVEAL_BASE_TIMING} triggerOnce>
                        <ServiceDiv
                            title={'КОНСУЛЬТАЦИЯ'}
