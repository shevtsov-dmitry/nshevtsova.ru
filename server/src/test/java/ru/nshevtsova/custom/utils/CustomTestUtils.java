...
public final class CustomTestUtils {
    ...
    private static final String[] reviews = {"Ваш профессионализм помог мне найти идеальную квартиру.",
            "Я очень уважаю ваш профессионализм и умение общаться с клиентами. С вами все хорошо - я нашел идеальную квартиру.",
            "Мне не хватало сил найти жилье по доступным ценам, но вы помогли мне сделать это.",
            "Я был недоволен нашим предыдущим агентом, который не мог помочь мне найти жилье по доступным ценам. С вами все отлично - я счастлив, что нашел",
            "Ваш профессионализм и умение общаться с клиентами помогли мне найти идеальную квартиру.",
            "Я очень доволен тем, что нашел идеальную квартиру с вашей помощью. Вы помогаете мне находить жилье по доступным ценам и я очень доволен своими",
            "Я всегда получаю отличные результаты, когда работаю с вами. Вы помогаете мне найти жилье по доступным ценам и я рад, что нашел квартиру.",
            "Мне не хватало сил найти идеальную квартиру, но вы помогли мне сделать это.",
            "Я был недоволен нашим предыдущим агентом, который не мог помочь мне найти жилье по доступным ценам. С вами все отлично - я счастлив, что нашел",
            "Я очень доволен тем, что нашел идеальную квартиру с вашей помощью. Вы помогаете мне находить жилье по доступным ценам и я очень доволен своими",
            "Я всегда получаю отличные результаты, когда работаю с вами. Вы помогаете мне найти жилье по доступным ценам и я рад, что нашел квартиру.",
            "Мне не хватало сил найти идеальную квартиру, но вы помогли мне сделать это.",
    ...
    public static String generateUserReview() {
        return reviews[(new Random()).nextInt(reviews.length)];
    }
